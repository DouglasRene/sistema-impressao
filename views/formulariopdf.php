...
<body>
    <div class="formulario1">
        ...
        <div class="tb-1">
            <table>
                ...
                <tr>
                    ...
                    <td style="border-bottom: 1px solid;" colspan="2">Data Admissãao Usuário: <strong><?= $_POST["dt_admiss_usr"] ?></strong></td>
                </tr>
                <tr>
                ...
                <tr>
                    ...
                    <td style="border-bottom: 1px solid;">Centro de Saúde: <strong><?= $_POST["centro_saude"] ?></strong></td>
                </tr>
                <tr>
		   ...
		   <td colspan="4">Cód. IBGE Munic: <strong>3509512</strong></td>
                ...
                <tr>
                    <td colspan="21" style="border-left: none; border-right: none;">CID 10 Causas Associadas: <strong><?= $_POST["cid10_caus_assoc"] == "" ? "" : utf8_encode($_POST["cid10_caus_assoc"]) ?></strong> </td>
                </tr>
                <tr>
		...
		<tr>
            ...
            <table border="1" style="font-size: 9px; margin-top: 75px;">
                <tr>
