...
<?php endif; ?>
<?php if ($formulario->status === "Inativo" && $pesquisa === "update" && $formulario->caps_id === $userData->caps_id) : ?>
    <style>
        .checkInativo {
            pointer-events: none;
        }
...
<div class="col-md-12">
    <?php if ($pesquisa === "update" && $formulario->caps_id == $userData->caps_id && $formulario->status == "Ativo") : ?>
                    ...
                    <tr>
                        ...
                        <td colspan="10">
                            <div class="d-flex flex-row">
                                ...
                                <input type="radio" id="Ativo" name="status" value="Ativo" class="m-1 check" <?= $formulario->status == "Ativo" ? "checked" : "false" ?>>
                                <label for="Inativo">Inativo</label>
                                <input type="radio" id="Inativo" name="status" value="Inativo" class="ml-1 check" <?= $formulario->status == "Inativo" ? "checked" : "false" ?>>
                                <div style="width: 10%; height: 20px;">
                                    ...
                                    <?php endif; ?>
                                    <?php if ($formulario->status === "Ativo" && $pesquisa === "update" && $formulario->caps_id == $userData->caps_id) : ?>
